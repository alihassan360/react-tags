...
class Suggestions extends React.Component {
  constructor (props) {
    ...
    this.state = {
      options: this.props.shouldFilterSuggestions 
        ? filterSuggestions(this.props.query, this.props.suggestions, this.props.maxSuggestionsLength)
  ...
  componentWillReceiveProps (newProps) {
    this.setState({
      options: newProps.shouldFilterSuggestions 
        ? filterSuggestions(newProps.query, newProps.suggestions, newProps.maxSuggestionsLength)
